...
<div class="sale-info-form">

    <?php $form = AppActiveForm::begin() ?>

    <?= $form->field($model, 'id_complex')->textInput() ?>

    <?= $form->field($model, 'sales_phone')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'address')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'sales_latitude')->textInput() ?>

    <?= $form->field($model, 'sales_longitude')->textInput() ?>
