...
/**
 * SaleInfoController implements the CRUD actions for SaleInfo model.
 *
 * @package admin\controllers
 */
final class SaleInfoController extends AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex(): string
    {
        ...
        $searchModel = new SaleInfoSearch();
    ...
    /**
     * Displays a single SaleInfo model.
     *
    ...
    public function actionCreate(string $redirect = null): Response|string
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(SaleInfoSearch::class)),
    ...
    /**
     * Updates an existing SaleInfo model.
     *
    ...
    /**
     * Deletes an existing SaleInfo model.
     *
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(SaleInfoSearch::class));
    }

    /**
     * Finds the SaleInfo model based on its primary key value.
     *
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): SaleInfo
    {
        if (($model = SaleInfo::findOne($id)) !== null) {
            return $model;
        }
