...
/**
 * RoomAreaController implements the CRUD actions for RoomArea model.
 *
 * @package admin\controllers
 */
final class RoomAreaController extends AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex(): string
    {
        ...
        $searchModel = new RoomAreaSearch();
    ...
    /**
     * Displays a single RoomArea model.
     *
    ...
    public function actionCreate(string $redirect = null): Response|string
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(RoomAreaSearch::class)),
    ...
    /**
     * Updates an existing RoomArea model.
     *
    ...
    /**
     * Deletes an existing RoomArea model.
     *
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(RoomAreaSearch::class));
    }

    /**
     * Finds the RoomArea model based on its primary key value.
     *
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): RoomArea
    {
        if (($model = RoomArea::findOne($id)) !== null) {
            return $model;
        }
